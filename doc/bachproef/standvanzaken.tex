...
Zo zijn zo genaamde kleine- en micro-onderneminge, die kleiner zijn dan 50 werknemers, en een jaaromzet of jaarlijks balanstotaal van minder dan 10 miljoen euro, vrijgesteld van de verplichting om een inventory of assets bij te houden~\autocite{nis2-eu-be}.
...
Dit draagt bij aan risicoanalyse en informatiebeveiligingsbeleid, waardoor bedrijven sneller kunnen reageren op incidenten en de impact ervan kunnen minimaliseren of zelfs voorkomen.
Dit is waar deze bachelorproef een bijdrage wil leveren door het ontwikkelen van een configuratie-inventaris~\autocite{dragos-nis2}.

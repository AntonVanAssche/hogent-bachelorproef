...
Hoewel PEASS-ng niet direct direct een rol speelt binnen configuration management, is het zeker een bekende binnen de wereld van cybersecurity.
...
Kan handig zijn om infrastructuur te defini\"eren in code met behulp van Terraform als IaC tool.
...
\begin{figure}[h!]
    ...
    \caption{\label{fig:snipe-it-dashboard}Snip-IT dashboard~\autocite{snipe-it-dashboard}.}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{\label{fig:lansweeper-dashboard}Lansweeper dashboard~\autocite{lansweeper-dashboard}.}
\end{figure}
